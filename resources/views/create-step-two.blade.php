...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <form action="{{ route('create_step_two_post') }}" method="POST">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $product->stock ?? '' }}}" class="form-control" id="stock" name="stock"/>
                            </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-6 text-left">
                                <a href="{{ route('create_step_one') }}" class="btn btn-danger pull-right">Previous</a>
                            </div>
